...
public class ScheduledCandidateLazyModel extends LazyDataModel<InterviewSchedule> {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 7366101350097439741L;
	...
	public ScheduledCandidateLazyModel(InterviewScheduleService interviewScheduleService,boolean isSalesManager,int userId){
